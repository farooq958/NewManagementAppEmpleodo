...
leading:
      ...
      body: StickyFooterScrollView(
        ...
        ///Policy Brief
              ...
              const PolicyBriefColumnWidget(string1: 'Force Timeout', string2: '300 mins after closing time',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Leniency Time', string2: '10 mins',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Early Arrival Policy', string2: 'Count shift Timing',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Max Early Arrival Time', string2: '0 mins',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Working Days', string2: 'Mon, Tue, Wed, Thu, Fri',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Timeout Policy', string2: 'Mark as Present',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Late Min Monthly Bucket', string2: '210 mins',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Late Comers Penalty ', string2: 'Late Mins x 1.5 mins',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Allowed Leaves', string2: '8 days',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Leave Assigned Group', string2: 'Standard Leaves',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Duty Duration', string2: '8 hrs,30 mins',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Bio Metric Machine', string2: 'Single Machine',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Minimum Overtime Required', string2: '10 Mins',),
              SizedBox(height: 10.sp,),
              ...
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Holiday Overtime', string2: 'Un Paid',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Holiday Overtime Ratio', string2: 'Un Paid',),
              SizedBox(height: 10.sp,),
              const PolicyBriefColumnWidget(string1: 'Pay Schedule', string2: 'Current',),
